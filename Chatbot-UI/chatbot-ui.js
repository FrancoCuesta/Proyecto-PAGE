function init() {
    ...
    //--------------------------- Variables Importantes----------------------------
    var inactiveMessage = "El servidor está inactivo, comuníquese con el desarrollador para activarlo"
...
//para enviar la entrada del usuario cuando presiona enter
...
// para mostrar el mensaje del usuario en la interfaz de usuario
...
function setBotResponse(val) {
    setTimeout(function() {
        if (val.length < 1) {
            //si no hay respuesta de rasa el msg = 'El servidor está inactivo, comuníquese con el administrador para activarlo';
            msg = inactiveMessage;
            ...
            //if ecibimos respuesta de Rasa
            for (i = 0; i < val.length; i++) {
                //comprobar si hay mensaje de texto
